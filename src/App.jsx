...
const FLOATERS = [
  { kind: 'flower', src: 3, left: '5%', top: '88%', width: '5.8rem', rot: '10deg', dur: '15s', delay: '-1s', path: 3, opacity: 0.92 },
  { kind: 'flower', src: 1, left: '78%', top: '86%', width: '7.6rem', rot: '-12deg', dur: '17s', delay: '-9s', path: 1, opacity: 0.95 },
  { kind: 'flower', src: 2, left: '38%', top: '90%', width: '5.6rem', rot: '8deg', dur: '19s', delay: '-4s', path: 2, opacity: 0.9 },
  { kind: 'petal', src: 1, left: '24%', top: '3%', width: '3.6rem', rot: '20deg', dur: '12s', delay: '-2s', path: 3, opacity: 0.92 },
  { kind: 'petal', src: 4, left: '66%', top: '2%', width: '3.4rem', rot: '-30deg', dur: '14s', delay: '-6s', path: 1, opacity: 0.9 },
  { kind: 'petal', src: 6, left: '12%', top: '8%', width: '4rem', rot: '40deg', dur: '11s', delay: '-1s', path: 2, opacity: 0.88 },
  { kind: 'petal', src: 2, left: '88%', top: '7%', width: '3rem', rot: '-12deg', dur: '13s', delay: '-8s', path: 3, opacity: 0.9 },
  { kind: 'petal', src: 7, left: '32%', top: '9%', width: '3.5rem', rot: '18deg', dur: '12s', delay: '-3s', path: 1, opacity: 0.86 },
  { kind: 'petal', src: 3, left: '74%', top: '6%', width: '3.3rem', rot: '-24deg', dur: '15s', delay: '-5s', path: 2, opacity: 0.88 },
  { kind: 'petal', src: 8, left: '2%', top: '91%', width: '3.2rem', rot: '32deg', dur: '13s', delay: '-10s', path: 3, opacity: 0.86 },
  { kind: 'petal', src: 5, left: '22%', top: '87%', width: '3.8rem', rot: '-8deg', dur: '11s', delay: '-2s', path: 1, opacity: 0.9 },
  { kind: 'petal', src: 9, left: '58%', top: '89%', width: '3.4rem', rot: '26deg', dur: '14s', delay: '-7s', path: 2, opacity: 0.88 },
  { kind: 'petal', src: 1, left: '88%', top: '92%', width: '3.1rem', rot: '-40deg', dur: '16s', delay: '-4s', path: 3, opacity: 0.84 },
  { kind: 'petal', src: 6, left: '48%', top: '93%', width: '3.6rem', rot: '12deg', dur: '13s', delay: '-11s', path: 1, opacity: 0.86 },
  { kind: 'petal', src: 4, left: '68%', top: '91%', width: '3.2rem', rot: '-18deg', dur: '12s', delay: '-6s', path: 2, opacity: 0.88 },
  { kind: 'sparkle', src: 1, left: '34%', top: '2%', width: '2.1rem', rot: '0deg', dur: '10s', delay: '-1s', path: 2, opacity: 1, twinkle: '3.1s' },
  { kind: 'sparkle', src: 3, left: '58%', top: '1%', width: '1.8rem', rot: '0deg', dur: '9s', delay: '-4s', path: 1, opacity: 1, twinkle: '2.6s' },
  { kind: 'sparkle', src: 7, left: '10%', top: '4%', width: '1.7rem', rot: '0deg', dur: '11s', delay: '-2s', path: 3, opacity: 0.95, twinkle: '3.8s' },
  { kind: 'sparkle', src: 2, left: '80%', top: '3%', width: '2rem', rot: '0deg', dur: '8s', delay: '-6s', path: 2, opacity: 1, twinkle: '2.9s' },
  { kind: 'sparkle', src: 10, left: '20%', top: '1%', width: '1.5rem', rot: '0deg', dur: '12s', delay: '-3s', path: 1, opacity: 0.9, twinkle: '4.2s' },
  { kind: 'sparkle', src: 4, left: '44%', top: '8%', width: '1.8rem', rot: '0deg', dur: '10s', delay: '-8s', path: 3, opacity: 0.92, twinkle: '3.4s' },
  { kind: 'sparkle', src: 8, left: '70%', top: '8%', width: '1.6rem', rot: '0deg', dur: '9s', delay: '-1s', path: 2, opacity: 0.95, twinkle: '2.8s' },
  { kind: 'sparkle', src: 5, left: '16%', top: '90%', width: '1.7rem', rot: '0deg', dur: '11s', delay: '-5s', path: 1, opacity: 0.95, twinkle: '3.6s' },
  { kind: 'sparkle', src: 11, left: '50%', top: '87%', width: '1.5rem', rot: '0deg', dur: '8s', delay: '-2s', path: 3, opacity: 0.9, twinkle: '2.4s' },
  { kind: 'sparkle', src: 6, left: '64%', top: '93%', width: '1.8rem', rot: '0deg', dur: '10s', delay: '-7s', path: 2, opacity: 0.95, twinkle: '3.2s' },
  { kind: 'sparkle', src: 9, left: '92%', top: '88%', width: '1.7rem', rot: '0deg', dur: '12s', delay: '-4s', path: 1, opacity: 0.92, twinkle: '4s' },
  { kind: 'sparkle', src: 12, left: '8%', top: '93%', width: '1.3rem', rot: '0deg', dur: '9s', delay: '-6s', path: 3, opacity: 0.88, twinkle: '2.2s' },
  { kind: 'sparkle', src: 1, left: '30%', top: '92%', width: '2rem', rot: '0deg', dur: '11s', delay: '-9s', path: 2, opacity: 1, twinkle: '3s' },
  { kind: 'sparkle', src: 2, left: '82%', top: '93%', width: '1.9rem', rot: '0deg', dur: '8s', delay: '-3s', path: 1, opacity: 0.95, twinkle: '2.7s' },
  { kind: 'flower', src: 1, left: '0.8%', top: '28%', width: '5.2rem', rot: '-8deg', dur: '16s', delay: '-3s', path: 2, opacity: 0.92 },
  { kind: 'flower', src: 3, left: '1.6%', top: '56%', width: '4.8rem', rot: '14deg', dur: '18s', delay: '-8s', path: 1, opacity: 0.9 },
  { kind: 'flower', src: 2, left: '91.5%', top: '30%', width: '5.4rem', rot: '-16deg', dur: '17s', delay: '-5s', path: 3, opacity: 0.93 },
  { kind: 'flower', src: 1, left: '92.5%', top: '58%', width: '4.7rem', rot: '10deg', dur: '15s', delay: '-11s', path: 2, opacity: 0.9 },
  { kind: 'petal', src: 2, left: '3%', top: '18%', width: '3.2rem', rot: '28deg', dur: '12s', delay: '-4s', path: 1, opacity: 0.9 },
  { kind: 'petal', src: 5, left: '1%', top: '38%', width: '3.5rem', rot: '-22deg', dur: '14s', delay: '-1s', path: 3, opacity: 0.88 },
  { kind: 'petal', src: 8, left: '4%', top: '48%', width: '3.1rem', rot: '36deg', dur: '13s', delay: '-7s', path: 2, opacity: 0.86 },
  { kind: 'petal', src: 3, left: '1.2%', top: '68%', width: '3.4rem', rot: '-14deg', dur: '15s', delay: '-9s', path: 1, opacity: 0.88 },
  { kind: 'petal', src: 7, left: '2.4%', top: '78%', width: '3rem', rot: '20deg', dur: '11s', delay: '-2s', path: 3, opacity: 0.86 },
  { kind: 'petal', src: 1, left: '92%', top: '14%', width: '3.3rem', rot: '-28deg', dur: '12s', delay: '-6s', path: 2, opacity: 0.9 },
  { kind: 'petal', src: 4, left: '94%', top: '40%', width: '3.2rem', rot: '18deg', dur: '14s', delay: '-3s', path: 1, opacity: 0.88 },
  { kind: 'petal', src: 6, left: '91%', top: '50%', width: '3.6rem', rot: '-32deg', dur: '13s', delay: '-10s', path: 3, opacity: 0.86 },
  { kind: 'petal', src: 9, left: '93.5%', top: '70%', width: '3.1rem', rot: '24deg', dur: '15s', delay: '-5s', path: 2, opacity: 0.88 },
  { kind: 'petal', src: 8, left: '95%', top: '80%', width: '2.9rem', rot: '-18deg', dur: '11s', delay: '-8s', path: 1, opacity: 0.84 },
  { kind: 'sparkle', src: 4, left: '6%', top: '22%', width: '1.6rem', rot: '0deg', dur: '10s', delay: '-2s', path: 3, opacity: 0.95, twinkle: '3.1s' },
  { kind: 'sparkle', src: 7, left: '2%', top: '34%', width: '1.4rem', rot: '0deg', dur: '9s', delay: '-6s', path: 1, opacity: 0.9, twinkle: '2.7s' },
  { kind: 'sparkle', src: 11, left: '5%', top: '46%', width: '1.5rem', rot: '0deg', dur: '11s', delay: '-1s', path: 2, opacity: 0.92, twinkle: '3.6s' },
  { kind: 'sparkle', src: 6, left: '1.5%', top: '64%', width: '1.7rem', rot: '0deg', dur: '8s', delay: '-9s', path: 3, opacity: 0.9, twinkle: '2.4s' },
  { kind: 'sparkle', src: 12, left: '4.5%', top: '74%', width: '1.3rem', rot: '0deg', dur: '12s', delay: '-4s', path: 1, opacity: 0.88, twinkle: '3.8s' },
  { kind: 'sparkle', src: 3, left: '90%', top: '20%', width: '1.6rem', rot: '0deg', dur: '10s', delay: '-3s', path: 2, opacity: 0.95, twinkle: '2.9s' },
  { kind: 'sparkle', src: 8, left: '95%', top: '34%', width: '1.4rem', rot: '0deg', dur: '9s', delay: '-7s', path: 1, opacity: 0.9, twinkle: '3.3s' },
  { kind: 'sparkle', src: 10, left: '91%', top: '46%', width: '1.5rem', rot: '0deg', dur: '11s', delay: '-2s', path: 3, opacity: 0.92, twinkle: '2.5s' },
  { kind: 'sparkle', src: 5, left: '94%', top: '64%', width: '1.7rem', rot: '0deg', dur: '8s', delay: '-8s', path: 2, opacity: 0.9, twinkle: '4s' },
  { kind: 'sparkle', src: 9, left: '89.5%', top: '76%', width: '1.4rem', rot: '0deg', dur: '12s', delay: '-5s', path: 1, opacity: 0.88, twinkle: '2.2s' },
]
